export function HeroSection() {
  return (
    <header className="relative flex flex-col items-center justify-center overflow-hidden px-4 pt-20 pb-28 text-center sm:px-6 sm:pt-24 sm:pb-36">
      ...
      {/* Radial glow */}
      <div className="pointer-events-none absolute top-1/2 left-1/2 h-[28rem] w-[28rem] -translate-x-1/2 -translate-y-1/2 rounded-full bg-gold-500/5 blur-3xl sm:h-[36rem] sm:w-[36rem]" />
      {/* Top vignette */}
      ...
      <div className="relative z-10 mx-auto w-full max-w-5xl">
        {/* Logo placeholder */}
        <div className="mx-auto mb-8 flex h-28 w-28 items-center justify-center rounded-full border-2 border-gold-700/30 bg-[#111] shadow-[0_0_80px_rgba(196,154,26,0.06)] sm:mb-10 sm:h-44 sm:w-44">
          <span className="font-display text-4xl font-bold tracking-wider text-gold-400 sm:text-5xl">NK</span>
        </div>

        <h1 className="font-display text-4xl font-bold tracking-[0.08em] text-gold-400 drop-shadow-[0_0_40px_rgba(196,154,26,0.2)] sm:text-5xl sm:tracking-[0.12em] md:text-7xl lg:text-8xl lg:tracking-[0.15em]">
          <span className="block lg:inline">Nameless</span>
          <span className="block lg:ml-[0.15em] lg:inline">Kingdom</span>
        </h1>
        ...
        <p className="mx-auto mt-6 max-w-2xl px-2 text-base leading-relaxed font-light text-neutral-400 sm:text-lg md:text-xl">
